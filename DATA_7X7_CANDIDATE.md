...
La categoría `national-league-club-titles` ya está definida en el catálogo, pero aún no tiene snapshot. Los hechos locales de las seis ligas domésticas actualmente importadas no alcanzan por sí solos el alcance mundial de títulos nacionales requerido; no se ha creado un ranking con padding.
