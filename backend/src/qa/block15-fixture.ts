...
if (!['127.0.0.1', 'localhost', '::1'].includes(parsed.hostname) || !parsed.pathname.includes('rango90_qa_block15a') || process.env.NODE_ENV === 'production') {
  throw new Error('El fixture Block 15A solo admite PostgreSQL efímero local');
}
