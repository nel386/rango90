...
export const RANKING_CATALOG_DEFINITIONS = [
  ...
  },
  {
    ...
    labelEs: 'Tarjetas amarillas — carrera de clubes',
    labelEn: 'Yellow cards — club career',
    descriptionEs: 'Acumulado de las temporadas disponibles de las cinco grandes ligas; cobertura parcial explícita.',
    descriptionEn: 'Aggregate of available seasons from the five major leagues; coverage is explicit and partial.',
    metric: 'yellow_cards' as const,
    scope: 'Carrera de clubes dentro de la cobertura API-Football',
  },
  {
    slug: 'club-yellow-cards-active-season',
    labelEs: 'Tarjetas amarillas — temporada actual',
    labelEn: 'Yellow cards — current season',
    descriptionEs: 'Solo la temporada activa; nunca se mezcla con carrera.',
    descriptionEn: 'Active season only; never mixed with career.',
    metric: 'yellow_cards' as const,
    scope: 'Temporada activa de clubes',
  },
  {
    slug: 'club-yellow-cards-active-players-career',
    labelEs: 'Tarjetas amarillas — carrera de jugadores activos',
    labelEn: 'Yellow cards — active players career',
    descriptionEs: 'Carrera disponible filtrada a jugadores con aparición en la temporada activa.',
    descriptionEn: 'Available career filtered to players appearing in the active season.',
    metric: 'yellow_cards' as const,
    scope: 'Carrera de clubes de jugadores activos',
  },
  {
