...
const artifactPrefix = process.env.BLOCK28_RUN === '1' ? 'BLOCK28' : process.env.BLOCK27_RUN === '1' ? 'BLOCK27' : 'BLOCK26';
const blockLabel = process.env.BLOCK28_RUN === '1' ? 'BLOQUE 28' : process.env.BLOCK27_RUN === '1' ? 'BLOQUE 27' : 'BLOQUE 26';
...
const apiReportFile = process.env.BLOCK28_API_REPORT_FILE?.trim() || process.env.BLOCK27_API_REPORT_FILE?.trim() || process.env.BLOCK26_API_REPORT_FILE?.trim() || '';
