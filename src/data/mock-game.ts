...
export const mockDailyChallenge: MockChallenge = {
  ...
  categories: [
    ...
    { slug: "national-league-club-titles", code: "TN", entityType: "club", label: { es: "Títulos nacionales del equipo", en: "Domestic league titles" }, definition: { es: "Títulos de primera división nacional ganados por el equipo.", en: "Domestic top-flight league titles won by the club." } },
    { slug: "european-cup-champions-league-club-titles", code: "CL", entityType: "club", label: { es: "Champions del equipo", en: "Champions League titles" }, definition: { es: "Títulos de Copa de Europa / Champions League ganados por el equipo.", en: "European Cup / Champions League titles won by the club." } },
  ],
  entities: [
    ...
    { id: "club-real-madrid", name: "Real Madrid", shortName: "RM", entityType: "club", position: "", scores: { "national-league-club-titles": 1, "european-cup-champions-league-club-titles": 1 } },
    { id: "club-barcelona", name: "FC Barcelona", shortName: "FCB", entityType: "club", position: "", scores: { "national-league-club-titles": 2, "european-cup-champions-league-club-titles": 4 } },
  ],
};
