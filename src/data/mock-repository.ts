...
export const mockGameRepository: GameRepository = {
  ...
  getRankingCategories: async (): Promise<RankingCategoryOption[]> => mockDailyChallenge.categories.map((category) => ({ slug: category.slug, labelEs: category.label.es, labelEn: category.label.en, availability: "provisional", status: "provisional_lab", selectable: true })),
